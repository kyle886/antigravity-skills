...
Implementation guidelines, checklists, and code patterns for **incident-responder**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to incident-responder architectural patterns
