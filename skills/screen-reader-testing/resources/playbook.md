...
Implementation guidelines, checklists, and code patterns for **screen-reader-testing**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to screen-reader-testing architectural patterns
