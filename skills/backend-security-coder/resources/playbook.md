# BACKEND-SECURITY-CODER Playbook

Implementation guidelines, checklists, and code patterns for **backend-security-coder**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to backend-security-coder architectural patterns
