...
Implementation guidelines, checklists, and code patterns for **frontend-developer**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to frontend-developer architectural patterns
