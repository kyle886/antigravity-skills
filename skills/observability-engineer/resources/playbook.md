...
Implementation guidelines, checklists, and code patterns for **observability-engineer**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to observability-engineer architectural patterns
