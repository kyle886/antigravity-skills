...
Implementation guidelines, checklists, and code patterns for **backend-architect**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to backend-architect architectural patterns
