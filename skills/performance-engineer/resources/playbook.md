...
Implementation guidelines, checklists, and code patterns for **performance-engineer**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to performance-engineer architectural patterns
