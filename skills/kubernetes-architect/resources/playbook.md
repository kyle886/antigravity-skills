# KUBERNETES-ARCHITECT Playbook

Implementation guidelines, checklists, and code patterns for **kubernetes-architect**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to kubernetes-architect architectural patterns
