# POSTMORTEM-WRITING Playbook

Implementation guidelines, checklists, and code patterns for **postmortem-writing**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to postmortem-writing architectural patterns
