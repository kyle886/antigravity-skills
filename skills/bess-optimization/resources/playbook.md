# BESS-OPTIMIZATION Playbook

Implementation guidelines, checklists, and code patterns for **bess-optimization**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to bess-optimization architectural patterns
