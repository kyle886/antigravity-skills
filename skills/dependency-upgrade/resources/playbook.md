...
Implementation guidelines, checklists, and code patterns for **dependency-upgrade**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to dependency-upgrade architectural patterns
