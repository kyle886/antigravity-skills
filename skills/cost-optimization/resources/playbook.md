...
Implementation guidelines, checklists, and code patterns for **cost-optimization**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to cost-optimization architectural patterns
