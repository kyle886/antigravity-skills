# SEO-KEYWORD-STRATEGIST Playbook

Implementation guidelines, checklists, and code patterns for **seo-keyword-strategist**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to seo-keyword-strategist architectural patterns
