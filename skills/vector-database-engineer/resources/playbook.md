# VECTOR-DATABASE-ENGINEER Playbook

Implementation guidelines, checklists, and code patterns for **vector-database-engineer**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to vector-database-engineer architectural patterns
