# IOS-DEVELOPER Playbook

Implementation guidelines, checklists, and code patterns for **ios-developer**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to ios-developer architectural patterns
