# CORE-WEB-VITALS-AUDIT Playbook

Implementation guidelines, checklists, and code patterns for **core-web-vitals-audit**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to core-web-vitals-audit architectural patterns
