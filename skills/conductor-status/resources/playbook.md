# CONDUCTOR-STATUS Playbook

Implementation guidelines, checklists, and code patterns for **conductor-status**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to conductor-status architectural patterns
