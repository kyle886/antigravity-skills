...
Implementation guidelines, checklists, and code patterns for **saga-orchestration**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to saga-orchestration architectural patterns
