# ARM-CORTEX-EXPERT Playbook

Implementation guidelines, checklists, and code patterns for **arm-cortex-expert**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to arm-cortex-expert architectural patterns
