...
Implementation guidelines, checklists, and code patterns for **legacy-modernizer**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to legacy-modernizer architectural patterns
