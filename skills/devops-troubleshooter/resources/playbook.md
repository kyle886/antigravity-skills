# DEVOPS-TROUBLESHOOTER Playbook

Implementation guidelines, checklists, and code patterns for **devops-troubleshooter**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to devops-troubleshooter architectural patterns
