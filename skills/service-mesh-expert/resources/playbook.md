# SERVICE-MESH-EXPERT Playbook

Implementation guidelines, checklists, and code patterns for **service-mesh-expert**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to service-mesh-expert architectural patterns
