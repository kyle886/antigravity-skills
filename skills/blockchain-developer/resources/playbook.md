...
Implementation guidelines, checklists, and code patterns for **blockchain-developer**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to blockchain-developer architectural patterns
