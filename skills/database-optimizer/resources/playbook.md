# DATABASE-OPTIMIZER Playbook

Implementation guidelines, checklists, and code patterns for **database-optimizer**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to database-optimizer architectural patterns
