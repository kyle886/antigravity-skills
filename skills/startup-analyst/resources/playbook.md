# STARTUP-ANALYST Playbook

Implementation guidelines, checklists, and code patterns for **startup-analyst**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to startup-analyst architectural patterns
