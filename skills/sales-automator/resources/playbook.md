# SALES-AUTOMATOR Playbook

Implementation guidelines, checklists, and code patterns for **sales-automator**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to sales-automator architectural patterns
