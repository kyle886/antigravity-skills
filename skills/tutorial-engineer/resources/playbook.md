# TUTORIAL-ENGINEER Playbook

Implementation guidelines, checklists, and code patterns for **tutorial-engineer**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to tutorial-engineer architectural patterns
