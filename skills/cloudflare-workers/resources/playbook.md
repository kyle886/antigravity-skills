...
Implementation guidelines, checklists, and code patterns for **cloudflare-workers**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to cloudflare-workers architectural patterns
