# THERMAL-SYSTEMS-ENGINEER Playbook

Implementation guidelines, checklists, and code patterns for **thermal-systems-engineer**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to thermal-systems-engineer architectural patterns
