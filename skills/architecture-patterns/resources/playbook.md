...
Implementation guidelines, checklists, and code patterns for **architecture-patterns**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to architecture-patterns architectural patterns
