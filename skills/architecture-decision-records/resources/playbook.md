...
Implementation guidelines, checklists, and code patterns for **architecture-decision-records**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to architecture-decision-records architectural patterns
