# DEPLOYMENT-ENGINEER Playbook

Implementation guidelines, checklists, and code patterns for **deployment-engineer**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to deployment-engineer architectural patterns
