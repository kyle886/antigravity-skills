...
Implementation guidelines, checklists, and code patterns for **rag-implementation**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to rag-implementation architectural patterns
