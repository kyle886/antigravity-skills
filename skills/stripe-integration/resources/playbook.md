...
Implementation guidelines, checklists, and code patterns for **stripe-integration**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to stripe-integration architectural patterns
