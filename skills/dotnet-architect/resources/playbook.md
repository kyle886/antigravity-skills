# DOTNET-ARCHITECT Playbook

Implementation guidelines, checklists, and code patterns for **dotnet-architect**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to dotnet-architect architectural patterns
