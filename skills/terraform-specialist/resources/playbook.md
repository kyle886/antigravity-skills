# TERRAFORM-SPECIALIST Playbook

Implementation guidelines, checklists, and code patterns for **terraform-specialist**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to terraform-specialist architectural patterns
