# SEO-SNIPPET-HUNTER Playbook

Implementation guidelines, checklists, and code patterns for **seo-snippet-hunter**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to seo-snippet-hunter architectural patterns
