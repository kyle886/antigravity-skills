# DATABASE-ADMIN Playbook

Implementation guidelines, checklists, and code patterns for **database-admin**.

## 1. Technical Implementation Checklist

- [ ] Verify environment prerequisites and dependencies are loaded
- [ ] Implement core logic conforming to database-admin architectural patterns
